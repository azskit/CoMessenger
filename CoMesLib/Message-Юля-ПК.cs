    ...
    public class HistoryManager
    {
        ...
        public void Save(HistoryEntry entryToSave)
        {
            ...
            lock (hFile)
            {
                ...
                using (DeflateStream compressedHistory = new DeflateStream(ms, CompressionMode.Compress, false))
                using (DeflateStream decompressedHistory = new DeflateStream(ms2, CompressionMode.Decompress, false))
                {
