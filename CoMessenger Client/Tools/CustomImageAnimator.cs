...
namespace COMessengerClient.Tools
{
    ...
    ///     from occurring.
    /// </devdoc>                                
    public class CustomImageAnimator
    {
        /// <devdoc> 
        ...
        private class ImageInfo
        {
            ...
            {
                this.image = image;
                animated = CustomImageAnimator.CanAnimate(image);
        ...
        static void AnimateImages50ms()
        {
            ...
            App.Log.Add("Animation", "Started");

            while (imageInfoList.Count>0)
            {
